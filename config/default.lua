...
global = {
    target_total_time_minutes = 240,       -- желаемое общее время эксперимента
...
scenarios = {
    ...
    },
    {
        ...
        phases = {
            { duration_ms =  8000, insert = 1.00, find = 0.00, erase = 0.00, key_dist = "uniform",  key_range = 1000000000 },
            { duration_ms = 12000, insert = 0.00, find = 1.00, erase = 0.00, key_dist = "zipfian", alpha = 0.99, key_range = 1000000 },
            { duration_ms =  6000, insert = 0.00, find = 0.00, erase = 1.00, key_dist = "zipfian", alpha = 0.99, key_range = 1000000 },
        }
    },
}
